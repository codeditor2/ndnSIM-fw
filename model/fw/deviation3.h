...
public:
  ...
  FaceMetricForMDPF3 (Ptr<Face> face, fib::FaceMetric::Status  status,Time sRtt, int32_t routingCost, double pi)
    : m_face (face)
   ...
   */
  bool
  operator< (const FaceMetricForMDPF3 &fm) const { return *m_face < *fm.m_face; } // return identity of the face

  /**
   * @brief Comparison between FaceMetricForMDPF3 and Face
   */
  bool
  operator< (const Ptr<Face> &face) const { return *m_face < *face; }

  /**
   * @brief Return Face associated with FaceMetricForMDPF3
   */
  Ptr<Face>
 ...
 */
struct FaceMetricForMDPF3Container
{
  /// @cond include_hidden
  typedef boost::multi_index::multi_index_container<
	...
	boost::multi_index::ordered_non_unique<
	  ...
	  boost::multi_index::const_mem_fun<FaceMetricForMDPF3,fib::FaceMetric::Status,&FaceMetricForMDPF3::GetStatus>
	>,
	
	// List of available faces ordered by (strr by default)
	boost::multi_index::ordered_non_unique<
	  boost::multi_index::tag<i_srtt>,
	  boost::multi_index::const_mem_fun<FaceMetricForMDPF3,Time,&FaceMetricForMDPF3::GetSRtt>
	  //,std::greater<Time>
	>,
	...
	boost::multi_index::ordered_non_unique<
	  ...
	  boost::multi_index::const_mem_fun<FaceMetricForMDPF3,double,&FaceMetricForMDPF3::GetPI>
	  //,std::greater<Time>
	>,
	...
	boost::multi_index::ordered_non_unique<
	  ...
	  boost::multi_index::composite_key<
	    FaceMetricForMDPF3,
	    boost::multi_index::const_mem_fun<FaceMetricForMDPF3,double,&FaceMetricForMDPF3::GetScore>,
	    boost::multi_index::const_mem_fun<FaceMetricForMDPF3,fib::FaceMetric::Status,&FaceMetricForMDPF3::GetStatus>, 
	    boost::multi_index::const_mem_fun<FaceMetricForMDPF3,int32_t,&FaceMetricForMDPF3::GetRoutingCost>
	  >,
 ...
 * @brief MDPF strategy
 */
class DeviationStrategy3 : public GreenYellowRed
{
private:
